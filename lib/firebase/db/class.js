...
export async function addClassMember(uid, classId) {
  try {
...
export async function deleteClassMember(uid, classId) {
  try {
    const classRef = doc(db, "classes", classId);
    const classDoc = await getDoc(classRef);
...
export async function deleteJoinRequest(uid, classId) {
  try {
    const joinRequestRef = doc(db, "classes", classId, "join_requests", uid);
...
export async function approveJoinRequest(uid, classId) {
  try {
